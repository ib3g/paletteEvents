!function(t,e){"function"==typeof define&&define.amd&&"function"==typeof require&&"function"==typeof require.specified&&require.specified("knockout")?define(["jquery","knockout"],e):e(t.jQuery,t.ko)}(this,function(d,h){"use strict";function o(t,e){this.$select=d(t),this.options=this.mergeOptions(d.extend({},e,this.$select.data())),this.$select.attr("data-placeholder")&&(this.options.nonSelectedText=this.$select.data("placeholder")),this.originalOptions=this.$select.clone()[0].options,this.query="",this.searchTimeout=null,this.lastToggledInput=null,this.options.multiple="multiple"===this.$select.attr("multiple"),this.options.onChange=d.proxy(this.options.onChange,this),this.options.onSelectAll=d.proxy(this.options.onSelectAll,this),this.options.onDeselectAll=d.proxy(this.options.onDeselectAll,this),this.options.onDropdownShow=d.proxy(this.options.onDropdownShow,this),this.options.onDropdownHide=d.proxy(this.options.onDropdownHide,this),this.options.onDropdownShown=d.proxy(this.options.onDropdownShown,this),this.options.onDropdownHidden=d.proxy(this.options.onDropdownHidden,this),this.options.onInitialized=d.proxy(this.options.onInitialized,this),this.options.onFiltering=d.proxy(this.options.onFiltering,this),this.buildContainer(),this.buildButton(),this.buildDropdown(),this.buildReset(),this.buildSelectAll(),this.buildDropdownOptions(),this.buildFilter(),this.updateButtonText(),this.updateSelectAll(!0),this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups(),this.options.wasDisabled=this.$select.prop("disabled"),this.options.disableIfEmpty&&d("option",this.$select).length<=0&&this.disable(),this.options.onInitialized(this.$select,this.$container)}void 0!==h&&h.bindingHandlers&&!h.bindingHandlers.multiselect&&(h.bindingHandlers.multiselect={after:["options","value","selectedOptions","enable","disable"],init:function(t,e,i,s,o){function l(t){setTimeout(function(){t?u.multiselect("enable"):u.multiselect("disable")})}var n,p,a,c,r,u=d(t),e=h.toJS(e());u.multiselect(e),i.has("options")&&(n=i.get("options"),h.isObservable(n))&&h.computed({read:function(){n(),setTimeout(function(){var t=u.data("multiselect");t&&t.updateOriginalOptions(),u.multiselect("rebuild")},1)},disposeWhenNodeIsRemoved:t}),i.has("value")&&(p=i.get("value"),h.isObservable(p))&&h.computed({read:function(){p(),setTimeout(function(){u.multiselect("refresh")},1)},disposeWhenNodeIsRemoved:t}).extend({rateLimit:100,notifyWhenChangesStop:!0}),i.has("selectedOptions")&&(a=i.get("selectedOptions"),h.isObservable(a))&&h.computed({read:function(){a(),setTimeout(function(){u.multiselect("refresh")},1)},disposeWhenNodeIsRemoved:t}).extend({rateLimit:100,notifyWhenChangesStop:!0});i.has("enable")&&(c=i.get("enable"),h.isObservable(c)?h.computed({read:function(){l(c())},disposeWhenNodeIsRemoved:t}).extend({rateLimit:100,notifyWhenChangesStop:!0}):l(c)),i.has("disable")&&(r=i.get("disable"),h.isObservable(r)?h.computed({read:function(){l(!r())},disposeWhenNodeIsRemoved:t}).extend({rateLimit:100,notifyWhenChangesStop:!0}):l(!r)),h.utils.domNodeDisposal.addDisposeCallback(t,function(){u.multiselect("destroy")})},update:function(t,e,i,s,o){t=d(t),e=h.toJS(e());t.multiselect("setOptions",e),t.multiselect("rebuild")}}),o.prototype={defaults:{buttonText:function(t,e){var i,s;return 0<this.disabledText.length&&e.prop("disabled")?this.disabledText:0===t.length?this.nonSelectedText:this.allSelectedText&&t.length===d("option",d(e)).length&&1!==d("option",d(e)).length&&this.multiple?this.selectAllNumber?this.allSelectedText+" ("+t.length+")":this.allSelectedText:0!=this.numberDisplayed&&t.length>this.numberDisplayed?t.length+" "+this.nSelectedText:(i="",s=this.delimiterText,t.each(function(){var t=void 0!==d(this).attr("label")?d(this).attr("label"):d(this).text();i+=t+s}),i.substr(0,i.length-this.delimiterText.length))},buttonTitle:function(t,e){var i,s;return 0===t.length?this.nonSelectedText:(i="",s=this.delimiterText,t.each(function(){var t=void 0!==d(this).attr("label")?d(this).attr("label"):d(this).text();i+=t+s}),i.substr(0,i.length-this.delimiterText.length))},checkboxName:function(t){return!1},optionLabel:function(t){return d(t).attr("label")||d(t).text()},optionClass:function(t){return d(t).attr("class")||""},onChange:function(t,e){},onDropdownShow:function(t){},onDropdownHide:function(t){},onDropdownShown:function(t){},onDropdownHidden:function(t){},onSelectAll:function(){},onDeselectAll:function(){},onInitialized:function(t,e){},onFiltering:function(t){},enableHTML:!1,buttonClass:"btn",inheritClass:!1,buttonWidth:"100%",buttonContainer:'<div class="dropdown"></div>',dropRight:!1,dropUp:!1,selectedClass:"",maxHeight:!1,includeSelectAllOption:!1,includeSelectAllIfMoreThan:0,selectAllText:" Select all",selectAllValue:"multiselect-all",selectAllName:!1,selectAllNumber:!0,selectAllJustVisible:!0,enableFiltering:!1,enableCaseInsensitiveFiltering:!1,enableFullValueFiltering:!1,enableClickableOptGroups:!1,enableCollapsibleOptGroups:!1,collapseOptGroupsByDefault:!1,filterPlaceholder:"Search",filterBehavior:"text",includeFilterClearBtn:!0,preventInputChangeEvent:!1,nonSelectedText:"None selected",nSelectedText:"selected",allSelectedText:"All selected",numberDisplayed:3,disableIfEmpty:!1,disabledText:"",delimiterText:", ",includeResetOption:!1,includeResetDivider:!1,resetText:"Reset",indentGroupOptions:!0,templates:{button:'<button type="button" class="multiselect dropdown-toggle" data-toggle="dropdown"><span class="multiselect-selected-text"></span></button>',popupContainer:'<div class="multiselect-container dropdown-menu"></div>',filter:'<div class="multiselect-filter"><div class="input-group"><div class="form-group-feedback form-group-feedback-left"><input type="text" class="multiselect-search form-control"><div class="form-control-feedback"><i class="icon-search4 text-muted"></i></div></div><div class="input-group-append multiselect-clear-filter"><button type="button" class="btn btn-light btn-icon"><i class="icon-cross"></i></button></div></div></div>',option:'<div class="multiselect-item"></div>',divider:'<div class="dropdown-divider"></div>',optionGroup:'<div class="multiselect-item multiselect-group"></div>',resetButton:'<div class="multiselect-reset text-center p-2"><button class="btn btn-sm btn-block btn-outline-secondary"></button></div>'}},constructor:o,buildContainer:function(){this.$container=d(this.options.buttonContainer),this.$select.wrap('<span class="multiselect-native-select"></span>').after(this.$container),this.$container.on("show.bs.dropdown",this.options.onDropdownShow),this.$container.on("hide.bs.dropdown",this.options.onDropdownHide),this.$container.on("shown.bs.dropdown",this.options.onDropdownShown),this.$container.on("hidden.bs.dropdown",this.options.onDropdownHidden)},buildButton:function(){this.$button=d(this.options.templates.button).addClass(this.options.buttonClass),this.$select.attr("class")&&this.options.inheritClass&&this.$button.addClass(this.$select.attr("class")),this.$select.prop("disabled")?this.disable():this.enable(),"100%"==this.options.buttonWidth&&(this.$button.css({width:this.options.buttonWidth,overflow:"hidden","text-overflow":"ellipsis"}),this.$container.css({width:this.options.buttonWidth})),"100%"!==this.options.buttonWidth&&"auto"!==this.options.buttonWidth&&(this.$container.wrap('<div class="d-inline-block position-relative"></div>'),this.$button.css({width:"100%"}),this.$container.parent().css({width:this.options.buttonWidth})),"auto"==this.options.buttonWidth&&this.$container.wrap('<div class="d-inline-block position-relative"></div>');var t=this.$select.attr("tabindex");t&&this.$button.attr("tabindex",t),this.$container.prepend(this.$button)},buildDropdown:function(){this.$popupContainer=d(this.options.templates.popupContainer),this.options.dropRight?this.$container.addClass("dropright"):this.options.dropUp&&this.$container.addClass("dropup"),this.options.maxHeight&&this.$popupContainer.css({"max-height":this.options.maxHeight+"px","overflow-y":"auto","overflow-x":"hidden"}),this.$popupContainer.on("touchstart click",function(t){t.stopPropagation()}),this.$container.append(this.$popupContainer)},buildDropdownOptions:function(){this.$select.children().each(d.proxy(function(t,e){var i=d(e),s=i.prop("tagName").toLowerCase();i.prop("value")!==this.options.selectAllValue&&("optgroup"===s?this.createOptgroup(e):"option"===s&&("divider"===i.data("role")?this.createDivider():this.createOptionValue(e,!1)))},this)),d(this.$popupContainer).off("change",'> *:not(.multiselect-group) input[type="checkbox"], > *:not(.multiselect-group) input[type="radio"]'),d(this.$popupContainer).on("change",'> *:not(.multiselect-group) input[type="checkbox"], > *:not(.multiselect-group) input[type="radio"]',d.proxy(function(t){var t=d(t.target),e=t.prop("checked")||!1,i=t.val()===this.options.selectAllValue,s=(this.options.selectedClass&&(e?t.closest(".multiselect-item").addClass(this.options.selectedClass):t.closest(".multiselect-item").removeClass(this.options.selectedClass)),t.val()),s=this.getOptionByValue(s),o=d("option",this.$select).not(s),t=d("input",this.$container).not(t);if(i?e?this.selectAll(this.options.selectAllJustVisible,!0):this.deselectAll(this.options.selectAllJustVisible,!0):(e?(s.prop("selected",!0),this.options.multiple?s.prop("selected",!0):(this.options.selectedClass&&d(t).closest(".dropdown-item").removeClass(this.options.selectedClass),d(t).prop("checked",!1),o.prop("selected",!1),this.$button.click()),"active"===this.options.selectedClass&&o.closest(".dropdown-item").css("outline","")):s.prop("selected",!1),this.options.onChange(s,e),this.updateSelectAll(),this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups()),this.$select.change(),this.updateButtonText(),this.options.preventInputChangeEvent)return!1},this)),d(".multiselect-item",this.$popupContainer).off("mousedown"),d(".multiselect-item",this.$popupContainer).on("mousedown",function(t){if(t.shiftKey)return!1}),d(this.$popupContainer).off("touchstart click",".multiselect-item .dropdown-item, .multiselect-all, .multiselect-group"),d(this.$popupContainer).on("touchstart click",".multiselect-item .dropdown-item, .multiselect-all, .multiselect-group",d.proxy(function(t){t.stopPropagation();var e=d(t.target);if(t.shiftKey&&this.options.multiple){e.is("input")||(t.preventDefault(),(e=e.closest(".multiselect-item").find("input")).prop("checked",!e.prop("checked")));var i=e.prop("checked")||!1;if(null!==this.lastToggledInput&&this.lastToggledInput!==e){var s,o=this.$popupContainer.find(".multiselect-item:visible").index(e.closest(".multiselect-item")),l=this.$popupContainer.find(".multiselect-item:visible").index(this.lastToggledInput.closest(".multiselect-item")),n=(l<o&&(s=l,l=o,o=s),++l,this.$popupContainer.find(".multiselect-item:not(.multiselect-filter-hidden)").slice(o,l).find("input"));n.prop("checked",i),this.options.selectedClass&&n.closest(".multiselect-item").toggleClass(this.options.selectedClass,i);for(var p=0,a=n.length;p<a;p++){var c=d(n[p]);this.getOptionByValue(c.val()).prop("selected",i)}}e.trigger("change")}else e.is("input")||((0<(c=e.closest(".multiselect-item, .multiselect-all").find(".custom-control-input")).length||this.options.enableClickableOptGroups&&this.options.multiple&&!e.hasClass("caret-container")&&0<(c=(s=(s=e).hasClass("multiselect-group")?s:e.closest(".multiselect-group")).find(".custom-control-input")).length)&&(c.prop("checked",!c.prop("checked")),c.change()),t.preventDefault());0<e.closest(".multiselect-item").find("input[type='checkbox'], input[type='radio']").length?this.lastToggledInput=e:this.lastToggledInput=null,e.blur()},this)),this.$container.off("keydown.multiselect").on("keydown.multiselect",d.proxy(function(t){var e,i,s;d("input.multiselect-search",this.$container).is(":focus")||(9===t.keyCode&&this.$container.hasClass("show")?this.$button.click():(s=d(this.$container).find(".multiselect-item:not(.disabled), .multiselect-group:not(.disabled), .multiselect-all").filter(":visible")).length&&(e=s.index(s.filter(":focus")),i=s.eq(e),32===t.keyCode&&((s=i.find("input")).prop("checked",!s.prop("checked")),s.change(),t.preventDefault()),13===t.keyCode)&&setTimeout(function(){i.focus()},0))},this)),this.options.enableClickableOptGroups&&this.options.multiple&&(d(".multiselect-group input",this.$popupContainer).off("change"),d(".multiselect-group input",this.$popupContainer).on("change",d.proxy(function(t){t.stopPropagation();var o=d(t.target).prop("checked")||!1,t=d(t.target).closest(".multiselect-group"),e=t.nextUntil(".multiselect-group").not(".multiselect-filter-hidden").not(".disabled").find("input"),l=[];this.options.selectedClass&&(o?t.addClass(this.options.selectedClass):t.removeClass(this.options.selectedClass)),d.each(e,d.proxy(function(t,e){var e=d(e),i=e.val(),s=this.getOptionByValue(i);o?(e.prop("checked",!0),e.closest(".dropdown-item").addClass(this.options.selectedClass),s.prop("selected",!0)):(e.prop("checked",!1),e.closest(".dropdown-item").removeClass(this.options.selectedClass),s.prop("selected",!1)),l.push(this.getOptionByValue(i))},this)),this.options.onChange(l,o),this.$select.change(),this.updateButtonText(),this.updateSelectAll()},this))),this.options.enableCollapsibleOptGroups&&this.options.multiple&&(d(".multiselect-group .caret-container",this.$popupContainer).off("click"),d(".multiselect-group .caret-container",this.$popupContainer).on("click",d.proxy(function(t){var t=d(t.target).closest(".multiselect-group").nextUntil(".multiselect-group").not(".multiselect-filter-hidden"),e=!0;t.each(function(){e=e&&!d(this).hasClass("multiselect-collapsible-hidden")}),e?t.hide().addClass("multiselect-collapsible-hidden"):t.show().removeClass("multiselect-collapsible-hidden")},this)))},createCheckbox:function(t,e,i,s,o,l){var n=d("<label />"),p=(n.addClass("dropdown-item custom-control flex-1"),"radio"===l?n.addClass("custom-radio"):n.addClass("custom-checkbox"),this.options.enableHTML&&0<d(e).length?n.append(d(e)):((p=d('<span class="custom-control-label w-100" />')).text(e),n.append(p)),d('<input class="custom-control-input"/>').attr("type",l));return p.val(s),n.prepend(p),i&&p.attr("name",i),t.prepend(n),t.attr("title",o||e),p},createOptionValue:function(t,e){var i=d(t),s=(i.is(":selected")&&i.prop("selected",!0),this.options.optionLabel(t)),o=this.options.optionClass(t),l=i.val(),n=this.options.multiple?"checkbox":"radio",p=i.attr("title"),a=d(this.options.templates.option),o=(a.addClass(o),e&&this.options.indentGroupOptions&&a.addClass("multiselect-group-option-indented"),this.options.collapseOptGroupsByDefault&&"optgroup"===d(t).parent().prop("tagName").toLowerCase()&&(a.addClass("multiselect-collapsible-hidden"),a.hide()),this.options.checkboxName(i)),e=this.createCheckbox(a,s,o,l,p,n),t=i.prop("selected")||!1;l===this.options.selectAllValue&&(a.addClass("multiselect-all"),a.removeClass("multiselect-item"),e.parent().parent().addClass("multiselect-all")),this.$popupContainer.append(a),i.is(":disabled")&&e.attr("disabled","disabled").prop("disabled",!0).closest(".dropdown-item").addClass("disabled"),e.prop("checked",t),t&&this.options.selectedClass&&e.closest(".dropdown-item").addClass(this.options.selectedClass)},createDivider:function(t){var e=d(this.options.templates.divider);this.$popupContainer.append(e)},createOptgroup:function(t){var e=d(t),i=e.attr("label"),s=e.attr("value"),o=e.attr("title"),l=d("<span class='multiselect-item multiselect-group dropdown-item-text'></span>"),s=(this.options.enableClickableOptGroups&&this.options.multiple?(l=d(this.options.templates.optionGroup),this.createCheckbox(l,i,null,s,o,"checkbox")):this.options.enableHTML?l.html(" "+i):l.text(" "+i),this.options.optionClass(t));l.addClass(s),this.options.enableCollapsibleOptGroups&&this.options.multiple&&(l.find(".custom-control").addClass("d-inline-block"),l.append('<span class="caret-container dropdown-toggle pl-1"></span>')),e.is(":disabled")&&l.addClass("disabled"),this.$popupContainer.append(l),d("option",t).each(d.proxy(function(t,e){this.createOptionValue(e,!0)},this))},buildReset:function(){var t;this.options.includeResetOption&&(this.options.includeResetDivider&&((t=d(this.options.templates.divider)).addClass("mt-0"),this.$popupContainer.prepend(t)),t=d(this.options.templates.resetButton),this.options.enableHTML?d("button",t).html(this.options.resetText):d("button",t).text(this.options.resetText),d("button",t).click(d.proxy(function(){this.clearSelection()},this)),this.$popupContainer.prepend(t))},buildSelectAll:function(){var t,e;"number"==typeof this.options.selectAllValue&&(this.options.selectAllValue=this.options.selectAllValue.toString()),!this.hasSelectAll()&&this.options.includeSelectAllOption&&this.options.multiple&&d("option",this.$select).length>this.options.includeSelectAllIfMoreThan&&(this.options.includeSelectAllDivider&&this.$popupContainer.prepend(d(this.options.templates.divider)),t=d(this.options.templates.li||this.options.templates.option),e=this.createCheckbox(t,this.options.selectAllText,this.options.selectAllName,this.options.selectAllValue,this.options.selectAllText,"checkbox"),t.addClass("multiselect-all"),t.removeClass("multiselect-item"),t.find(".custom-control-label").addClass("font-weight-bold"),this.$popupContainer.prepend(t),e.prop("checked",!1))},buildFilter:function(){var t;(this.options.enableFiltering||this.options.enableCaseInsensitiveFiltering)&&(t=Math.max(this.options.enableFiltering,this.options.enableCaseInsensitiveFiltering),this.$select.find("option").length>=t)&&(this.$filter=d(this.options.templates.filter),d("input",this.$filter).attr("placeholder",this.options.filterPlaceholder),this.options.includeFilterClearBtn?(this.isFirefox()&&0===this.$filter.find(".multiselect-clear-filter").length&&this.$filter.append("<i class='icon-cross text-muted multiselect-clear-filter multiselect-moz-clear-filter'></i>"),this.$filter.find(".multiselect-clear-filter").on("click",d.proxy(function(t){clearTimeout(this.searchTimeout),this.query="",this.$filter.find(".multiselect-search").val(""),d(".dropdown-item",this.$popupContainer).show().removeClass("multiselect-filter-hidden"),this.updateSelectAll(),this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups()},this))):(this.$filter.find(".multiselect-search").attr("type","text"),this.$filter.find(".multiselect-clear-filter").remove()),this.$popupContainer.prepend(this.$filter),this.$filter.val(this.query).on("click",function(t){t.stopPropagation()}).on("input keydown",d.proxy(function(t){13===t.which&&t.preventDefault(),this.isFirefox()&&this.options.includeFilterClearBtn&&(t.target.value?this.$filter.find(".multiselect-moz-clear-filter").show():this.$filter.find(".multiselect-moz-clear-filter").hide()),clearTimeout(this.searchTimeout),this.searchTimeout=this.asyncFunction(d.proxy(function(){var l,n;this.query!==t.target.value&&(this.query=t.target.value,d.each(d(".multiselect-item, .multiselect-group",this.$popupContainer),d.proxy(function(t,e){var i=0<d("input",e).length?d("input",e).val():"",s=d(".custom-control-label",e).text(),o="";"text"===this.options.filterBehavior?o=s:"value"===this.options.filterBehavior?o=i:"both"===this.options.filterBehavior&&(o=s+"\n"+i),i!==this.options.selectAllValue&&s&&(i=!1,this.options.enableCaseInsensitiveFiltering&&(o=o.toLowerCase(),this.query=this.query.toLowerCase()),this.options.enableFullValueFiltering&&"both"!==this.options.filterBehavior?(s=o.trim().substring(0,this.query.length),-1<this.query.indexOf(s)&&(i=!0)):-1<o.indexOf(this.query)&&(i=!0),i||(d(e).css("display","none"),d(e).addClass("multiselect-filter-hidden")),i&&(d(e).css("display","block"),d(e).removeClass("multiselect-filter-hidden")),d(e).hasClass("multiselect-group")?(l=e,n=i):(i&&d(l).show().removeClass("multiselect-filter-hidden"),!i&&n&&d(e).show().removeClass("multiselect-filter-hidden")))},this))),this.updateSelectAll(),this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups(),this.options.onFiltering(t.target)},this),300,this)},this)))},destroy:function(){this.$container.remove(),this.$select.show(),this.$select.prop("disabled",this.options.wasDisabled),this.$select.data("multiselect",null)},refresh:function(){var s={};d(".multiselect-item input",this.$popupContainer).each(function(){s[d(this).val()]=d(this)}),d("option",this.$select).each(d.proxy(function(t,e){var i=d(e),e=s[d(e).val()];i.is(":selected")?(e.prop("checked",!0),this.options.selectedClass&&e.closest(".multiselect-item").addClass(this.options.selectedClass)):(e.prop("checked",!1),this.options.selectedClass&&e.closest(".multiselect-item").removeClass(this.options.selectedClass)),i.is(":disabled")?e.attr("disabled","disabled").prop("disabled",!0).closest(".multiselect-item").addClass("disabled"):e.prop("disabled",!1).closest(".multiselect-item").removeClass("disabled")},this)),this.updateButtonText(),this.updateSelectAll(),this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups()},select:function(t,e){d.isArray(t)||(t=[t]);for(var i=0;i<t.length;i++){var s,o=t[i];null!=o&&(s=this.getOptionByValue(o),o=this.getInputByValue(o),void 0!==s&&void 0!==o&&(this.options.multiple||this.deselectAll(!1),this.options.selectedClass&&o.closest(".dropdown-item").addClass(this.options.selectedClass),o.prop("checked",!0),s.prop("selected",!0),e))&&this.options.onChange(s,!0)}this.updateButtonText(),this.updateSelectAll(),this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups()},clearSelection:function(){this.deselectAll(!1),this.updateButtonText(),this.updateSelectAll(),this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups()},deselect:function(t,e){d.isArray(t)||(t=[t]);for(var i=0;i<t.length;i++){var s,o=t[i];null!=o&&(s=this.getOptionByValue(o),o=this.getInputByValue(o),void 0!==s&&void 0!==o&&(this.options.selectedClass&&o.closest(".dropdown-item").removeClass(this.options.selectedClass),o.prop("checked",!1),s.prop("selected",!1),e))&&this.options.onChange(s,!1)}this.updateButtonText(),this.updateSelectAll(),this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups()},selectAll:function(t,e){var t=void 0===t||t,i=d(".multiselect-item:not(.disabled)",this.$popupContainer),s=d(".multiselect-item:not(.disabled):not(.multiselect-filter-hidden):not(.multiselect-collapisble-hidden)",this.$popupContainer).filter(":visible");t?(d("input:enabled",s).prop("checked",!0),s.addClass(this.options.selectedClass),d("input:enabled",s).each(d.proxy(function(t,e){e=d(e).val(),e=this.getOptionByValue(e);d(e).prop("selected",!0)},this))):(d("input:enabled",i).prop("checked",!0),i.addClass(this.options.selectedClass),d("input:enabled",i).each(d.proxy(function(t,e){e=d(e).val(),e=this.getOptionByValue(e);d(e).prop("selected",!0)},this))),d('.multiselect-item input[value="'+this.options.selectAllValue+'"]',this.$popupContainer).prop("checked",!0),this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups(),this.updateButtonText(),this.updateSelectAll(),e&&this.options.onSelectAll()},deselectAll:function(t,e){var t=void 0===t||t,i=d(".multiselect-item:not(.disabled):not(.multiselect-group)",this.$popupContainer),s=d(".multiselect-item:not(.disabled):not(.multiselect-filter-hidden):not(.multiselect-collapisble-hidden)",this.$popupContainer).filter(":visible");t?(d('input[type="checkbox"]:enabled',s).prop("checked",!1),s.removeClass(this.options.selectedClass),d('input[type="checkbox"]:enabled',s).each(d.proxy(function(t,e){e=d(e).val(),e=this.getOptionByValue(e);d(e).prop("selected",!1)},this))):(d('input[type="checkbox"]:enabled',i).prop("checked",!1),i.removeClass(this.options.selectedClass),d('input[type="checkbox"]:enabled',i).each(d.proxy(function(t,e){e=d(e).val(),e=this.getOptionByValue(e);d(e).prop("selected",!1)},this))),d('.multiselect-all input[value="'+this.options.selectAllValue+'"]',this.$popupContainer).prop("checked",!1),this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups(),this.updateButtonText(),this.updateSelectAll(),e&&this.options.onDeselectAll()},rebuild:function(){this.$popupContainer.html(""),this.options.multiple="multiple"===this.$select.attr("multiple"),this.buildSelectAll(),this.buildDropdownOptions(),this.buildFilter(),this.updateButtonText(),this.updateSelectAll(!0),this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups(),this.options.disableIfEmpty&&d("option",this.$select).length<=0?this.disable():this.enable(),this.options.dropRight?this.$container.addClass("dropright"):this.options.dropUp&&this.$container.addClass("dropup")},dataprovider:function(t){var a=0,c=this.$select.empty();d.each(t,function(t,e){if(d.isArray(e.children)){a++;for(var s=d("<optgroup/>").attr({label:e.label||"Group "+a,disabled:!!e.disabled,value:e.value}),i=e.children,o=function(t){var e,i={value:t.value,label:t.label||t.value,title:t.title,selected:!!t.selected,disabled:!!t.disabled};for(e in t.attributes)i["data-"+e]=t.attributes[e];s.append(d("<option/>").attr(i))},l=0;l<i.length;++l)o(i[l],l)}else{var n,p={value:e.value,label:e.label||e.value,title:e.title,class:e.class,selected:!!e.selected,disabled:!!e.disabled};for(n in e.attributes)p["data-"+n]=e.attributes[n];(s=d("<option/>").attr(p)).text(e.label||e.value)}c.append(s)}),this.rebuild()},enable:function(){this.$select.prop("disabled",!1),this.$button.prop("disabled",!1).removeClass("disabled"),this.updateButtonText()},disable:function(){this.$select.prop("disabled",!0),this.$button.prop("disabled",!0).addClass("disabled"),this.updateButtonText()},setOptions:function(t){this.options=this.mergeOptions(t)},mergeOptions:function(t){return d.extend(!0,{},this.defaults,this.options,t)},hasSelectAll:function(){return 0<d(".multiselect-all",this.$popupContainer).length},updateOptGroups:function(){var t=d(".multiselect-group",this.$popupContainer),i=this.options.selectedClass;t.each(function(){var t=d(this).nextUntil(".multiselect-group").not(".multiselect-filter-hidden").not(".disabled"),e=!0;t.each(function(){d("input",this).prop("checked")||(e=!1)}),i&&(e?d(this).addClass(i):d(this).removeClass(i)),d("input",this).prop("checked",e)})},updateSelectAll:function(t){var e,i,s,o;this.hasSelectAll()&&(e=(i=d(".multiselect-item:not(.multiselect-filter-hidden):not(.multiselect-group):not(.disabled) input:enabled",this.$popupContainer)).length,i=i.filter(":checked").length,o=(s=d(".multiselect-all",this.$popupContainer)).find("input"),0<i&&i===e?(o.prop("checked",!0),s.addClass(this.options.selectedClass)):(o.prop("checked",!1),s.removeClass(this.options.selectedClass)))},updateButtonText:function(){var t=this.getSelected();this.options.enableHTML?d(".multiselect .multiselect-selected-text",this.$container).html(this.options.buttonText(t,this.$select)):d(".multiselect .multiselect-selected-text",this.$container).text(this.options.buttonText(t,this.$select)),d(".multiselect",this.$container).attr("title",this.options.buttonTitle(t,this.$select))},getSelected:function(){return d("option",this.$select).filter(":selected")},getOptionByValue:function(t){for(var e=d("option",this.$select),i=t.toString(),s=0;s<e.length;s+=1){var o=e[s];if(o.value===i)return d(o)}},getInputByValue:function(t){for(var e=d(".multiselect-item input:not(.multiselect-search)",this.$popupContainer),i=t.toString(),s=0;s<e.length;s+=1){var o=e[s];if(o.value===i)return d(o)}},updateOriginalOptions:function(){this.originalOptions=this.$select.clone()[0].options},asyncFunction:function(t,e,i){var s=Array.prototype.slice.call(arguments,3);return setTimeout(function(){t.apply(i||window,s)},e)},setAllSelectedText:function(t){this.options.allSelectedText=t,this.updateButtonText()},isFirefox:function(){return!(!navigator||!navigator.userAgent)&&-1<navigator.userAgent.toLocaleLowerCase().indexOf("firefox")}},d.fn.multiselect=function(e,i,s){return this.each(function(){var t=d(this).data("multiselect");t||(t=new o(this,"object"==typeof e&&e),d(this).data("multiselect",t)),"string"==typeof e&&(t[e](i,s),"destroy"===e)&&d(this).data("multiselect",!1)})},d.fn.multiselect.Constructor=o,d(function(){d("select[data-role=multiselect]").multiselect()})});
